...
- (void)setHx_backgroundColor:(UIColor *)hx_backgroundColor
{
    _hx_backgroundColor = hx_backgroundColor;
    _collectionView.backgroundColor = _hx_backgroundColor;
}
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // 固定宽度
    if (_tagAttribute.itemWidth > 0) {
        return CGSizeMake(_tagAttribute.itemWidth, layout.itemSize.height);
    }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.layer.borderColor = _tagAttribute.normalBorderColor.CGColor;
